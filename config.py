...
# @YassirAppBot - общая дверь обеих половин (22.09.2026, core/app_bot.py):
# вход на сайт и первая встреча с новичком. Слушает его только мужской
# процесс - два getUpdates на один токен Telegram не даёт (409). Пусто -
...
# Ответы ИИ на прямые вопросы («Яссир, …» в группе, вопросы устазов и
# супер-админа в личке) выключены с 15.09.2026 решением пользователя:
# «не отвечать, есть устазы групп, они ответят». Флаг - чтобы вернуть без
# правки кода.
AI_ANSWER_QUESTIONS = os.getenv("AI_ANSWER_QUESTIONS", "false").lower() == "true"
