...
COMPARE = {
    ...
    # Точка в полосе списка отвергнута (14.09.2026): полоса - сдачи по заданиям.
    "lesson_ustaz": [("student_now", "Сейчас · месяц"), ("les_cal", "Месяц · точка"),
                     ("les_cal_confirm", "Тап по дню · снять")],
