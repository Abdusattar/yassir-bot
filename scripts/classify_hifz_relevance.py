...
AYAH_TAGS_MAYBE = {"remembrance", "mercy", "faith", "character"}

# Арабские паттерны, указывающие что аят обращён к неверующим с угрозой —
# такие аяты не подходят для мотивации студентов вне контекста
AYAH_DISBELIEVER_PATTERNS = [
