...
* 70% группы дошли до стр. 7 заучивания - группе открывается таджвид
  (23.09.2026, решение пользователя; было полджуза, стр. 12); 70% прошли
  первый джуз - нахв. Учат с Аль-Бакары (стр. 2), джуз - 20 страниц:
  указатель заучивания на стр. 7 / 22 и дальше. Считаются ВСЕ активные
  студенты; без указателя - «не прошёл».
