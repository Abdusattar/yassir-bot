...
_DEFAULT_KNOWLEDGE = [
    ...
    "Максимум 14 дней пропусков за месяц. При 14 пропусках → перевод в Тадаббур.",

    "ОБЫЧНЫЕ ГРУППЫ: гибкий режим. Те же задания что в ПРО. "
    "Максимум 30 дней пропусков. При 30 пропусках → перевод в Тадаббур. "
    "При ≤3 пропусках за 30 дней устаз может предложить студенту перевод в ПРО.",
    ...
    "ОБЯЗАННОСТИ УСТАЗА: добавляет студентов (/addstudent Имя Телефон), "
    "настраивает задания (/settasks), задаёт тип и язык группы (/setgroup), "
    "добавляет знания для бота (/teach текст), "
    "принимает решения о переводах, проводит онлайн-уроки.",
]
