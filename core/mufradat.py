...
#
# 30.08.2026 порог опускали до 3 - чтобы слова быстрее уходили на отдых и
# давали дорогу непоказанным. ВЕРНУЛИ обратно 5 в тот же день, замерив
# эффект: охват даёт не порог, а волна наименее показанных слов
# (COVERAGE_WAVE_SHARE ниже). Симуляция на реальном pick_question_word
# (пул 1000, 40 ответов/день, 60 дней), слов не показано ни разу:
#     страйк 3 без волны - 66     страйк 5 без волны - 88
#     страйк 3 С волной  -  0     страйк 5 С волной  -  0
# То есть при волне порог на охват не влияет вообще, а платить за него
# пришлось бы дважды: слово уходило бы на 2 месяца, показав себя всего 3
# раза подряд, и "Общий вес" разом вырос бы на 63% без единого нового
# ответа (замер по проду: 12981 запись, средний вклад слова 0.245 -> 0.400,
# "закреплено" 0 -> 775 слов). Корректность оценки важна - решение
# пользователя.
MASTERY_STREAK = 5
