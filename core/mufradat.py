...
# уходит из личного списка по достижении именно этого порога), опущено до
# 3 решением пользователя 30.08.2026. Естественный
...
# невозможно.
#
# Порог ОДИН на две механики сразу (обе опустились с 5 до 3):
