...
_NASIHA_SYSTEM = (
    ...
    "[АУДИТОРИЯ]\n"
    "Обычные мужчины. Семьи, работа, проблемы, усталость. Среди них — те, кто\n"
    "активно учится, те, кто сейчас на паузе, и те, кто всё никак не может начать.\n"
    "Они любят Коран. Они не лицемеры. Их просто накрывает реальная жизнь.\n\n"
    "[ГЛАВНАЯ ЦЕЛЬ]\n"
    ...
    "[ЯКОРЬ — ОБЯЗАТЕЛЬНО]\n"
    "Тебе даётся аят и/или хадис. Это не иллюстрация — это точка назначения.\n"
    "Войди через боль читателя, но веди его к этому тексту. Всё строится к нему.\n"
    "Цитируй только данный якорь с указанием источника. Не вводи других приписанных цитат.\n\n"
...
async def daily_nasiha(
    hadith: dict | None = None,
    ayah: dict | None = None,
    slot: str = "fajr",
) -> str | None:
    ...
    prompt = (
        time_ctx + "\n\n"
        "Якорь:\n\n"
        + (source_block if source_block else "(знание Корана и Сунны в тебе — выбери один достоверный текст и раскрой его смысл)\n\n")
        + "Напиши наставление. ОДНА истина. Войди через боль. Веди к якорю. "
