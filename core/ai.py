...
_TADABBUR_POST_SYSTEM = (
    ...
    "[АУДИТОРИЯ]\n"
    "Обычные мужчины в середине рабочего дня. Не в мечети, не на духовном ретрите.\n"
    "Между звонками, поездками, усталостью. Они слышали много слов про Коран.\n"
    "Им нужно не слово — им нужна точка соприкосновения с реальностью.\n\n"
    ...
    "3. КОРАНСКИЙ ЯКОРЬ: один аят или смысл из Корана — как зеркало.\n"
    ...
    "4. РЕАЛЬНОСТЬ: то, что на самом деле есть. Что Аллах уже дал, приготовил, показал.\n"
