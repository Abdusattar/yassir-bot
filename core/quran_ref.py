...
#
# 27.07.2026 (группа 7, аят 2:45): пробовал расширить этот regex под
# уthmани-значки рецитации (ۖ-ۭ, ۥ/ۦ small waw/yeh и т.п.) - ОТКАЧЕНО.
# Часть этих меток ("small waw/yeh") в рецитационном письме иногда
# замещает РЕАЛЬНУЮ букву (إِيلَافِهِمْ пишется إِۦلَـٰفِهِمْ - там ۦ это
# буква ي, не украшение), и снятие превращало разные слова в один и тот же
# ключ (сломало recall-тест на реальной ошибке Бекхана). Верное решение -
# не пытаться угадывать по символам, а индексировать ОБЕ формы слова
# (imlaey и uthmani) как есть, см. build_quran_index в scratchpad -
# copy-paste студента из мусхаф-приложения тогда совпадёт побуквенно с
# uthmani-формой из индекса без всякого угадывания.
