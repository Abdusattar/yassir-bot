...
SKILLS = (
    ...
    # Урок «повеление» - последний из трёх времён (24.09.2026): до него
    # вариант «амр» спрашивал бы непройденное.
    {"id": "tense", "lesson": "الفعل الأمر وعلامته", "title": "Время глагола",
