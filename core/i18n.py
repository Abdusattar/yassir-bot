...
TR = {
    ...
    "rating_header": {
        "ru": "🏆 Рейтинг — {title} ({start}–{end}):\n",
        "ky": "🏆 Рейтинг — {title} ({start}–{end}):\n",
        "uz": "🏆 Reyting — {title} ({start}–{end}):\n",
        "kk": "🏆 Рейтинг — {title} ({start}–{end}):\n",
        "ar": "🏆 الترتيب — {title} ({start}–{end}):\n",
        "en": "🏆 Rating — {title} ({start}–{end}):\n",
    },
    "rating_points": {
        "ru": "очков",
        "ky": "упай",
