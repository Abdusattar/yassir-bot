...
TR = {
    ...
    "join_already_active_elsewhere": {
        "ru": "{name} уже активен в другой группе («{title}») — не добавлен сюда автоматически. Если хочешь перевести — сначала убери из старой группы.",
    },
    "upgrade_nudge_group": {
        "ru": (
            "🌟 {name}, МашаАллах! Ты стабильно сдаёшь задания уже 30 дней — "
