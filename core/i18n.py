...
TR = {
    ...
    "app_only_countdown": {
        "ru": ("📱 Через {days} — {date} — задания в этой группе принимаются только "
               "через YassirApp.\n\n"
               "Открой чат со мной и нажми кнопку «YassirApp» слева от поля ввода. "
    ...
    "app_only_tomorrow": {
        "ru": ("📱 Завтра, {date}, задания в этой группе принимаются только через "
               "YassirApp.\n\n"
               "Кто ещё не заходил — зайди сегодня и попробуй сдать: кнопка «YassirApp» "
               "в чате со мной, дверь «Знания» показывает каждый шаг.\n\n"
    ...
    "app_only_today": {
        "ru": ("📱 С сегодняшнего дня задания принимаются только через YassirApp.\n\n"
               ...
               "Кнопка «YassirApp» — в чате со мной, слева от поля ввода. Дверь «Знания» "
