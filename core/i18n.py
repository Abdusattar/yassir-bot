...
TR = {
    ...
    "attendance_ask_superadmin": {
        "ru": "❓ Устаз не ответил 30 минут — можете подтвердить вы?\n\nГруппа: «{group}»\nОтметились: {names}",
    },
    "attendance_yes_btn": {
        "ru": "✅ Да, урок был",
    },
    ...
    "attendance_denied_group": {
        "ru": "⚠️ Урока сегодня не было — устаз это подтвердил. Писать «у» без реального участия в уроке недопустимо, баллы за это не начисляются.",
    },
    "ask_words": {
