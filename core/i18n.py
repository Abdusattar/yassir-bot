...
TR = {
    ...
    "prep_return_to_origin": {
        "ru": "🎉 МашаАллах! Условие подготовительной выполнено — можешь возвращаться в свою группу «{title}» 🤲\n👉 {link}",
        "ky": "🎉 МашаАллах! Даярдык шарты аткарылды — «{title}» тобуңа кайра кошула аласың 🤲\n👉 {link}",
    },
